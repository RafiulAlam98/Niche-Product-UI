          ...
          <Col xs={12} md={12} lg={6}>
               <Card className="card-style mt-3 mb-5 ">
                    ...
                    <Card.Body className="d-flex flex-column justify-content-start align-items-start">
                         ...
                         <Card.Subtitle className="mb-3 card-text">Fuel: {fuel}</Card.Subtitle>
                         <Card.Subtitle className="mb-3 card-text">Mile: {mile}</Card.Subtitle>
                         <Card.Subtitle className="mb-3 card-text">Type: {type}</Card.Subtitle>
